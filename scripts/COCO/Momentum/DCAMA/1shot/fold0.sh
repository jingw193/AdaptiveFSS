...
CUDA_VISIBLE_DEVICES=0 python -u -m torch.distributed.launch --nnodes=1 --nproc_per_node=1 --node_rank=0 --master_port=11004 \
./train_finetune.py --datapath "dataset/" \
           ...
           --image_size 384 \
           --test_freq 5 \
           --logpath "./logs/AdaptiveFSS/DCAMA/COCO/one_shot" \
           --lr $lr \
