...
CUDA_VISIBLE_DEVICES=0,1 python -u -m torch.distributed.launch --nnodes=1 --nproc_per_node=2 --node_rank=0 --master_port=11006 \
./train_finetune.py --datapath "dataset/" \
           ...
           --image_size 384 \
           --test_freq 5 \
           --logpath "./logs/AdaptiveFSS/DCAMA/COCO/five_shot" \
           --lr $lr \
